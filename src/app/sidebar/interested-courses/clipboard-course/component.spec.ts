...
import { ClipboardCourseComponent } from './component';
...
describe("Testing Course component", function() {
  let component: ClipboardCourseComponent;
  let fixture: ComponentFixture<ClipboardCourseComponent>;
  let de: DebugElement;
