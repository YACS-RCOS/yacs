...
import { ClipboardSectionComponent } from './component';
import { ConflictsService } from '../../../services/conflicts.service';

describe("Testing Section component", function() {
  let component: ClipboardSectionComponent;
  let fixture: ComponentFixture<ClipboardSectionComponent>;
  let de: DebugElement;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
       declarations: [ ClipboardSectionComponent ],
       providers: [{ provide: ConflictsService, useClass: MockConflictsService }]
    }).compileComponents();

    fixture = TestBed.createComponent(ClipboardSectionComponent);
