...
If you do not have a ssl certificate on hand, you can generate one for free using the Let's Encrypt cert bot. Then, simply move the generated keys to this directory and modify the nginx config accordingly.
