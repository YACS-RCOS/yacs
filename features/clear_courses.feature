...
Scenario: clear courses
  ...
  When I click the course "1200"
    Then I should see the course "1200" is selected
    And I should see the sections in course "1200" are selected
  ...
  When I click the clear button
    Then I should not see schedule events
  Then I break
